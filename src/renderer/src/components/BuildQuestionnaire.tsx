      ...
      >
        ...
        {loading || !current ? (
          <div className="flex min-h-[300px] flex-col items-center justify-center gap-3 px-8 text-center">
            ...
            <div className="text-[14px] font-medium text-fg">{ui.translating}</div>
          </div>
        ) : (
          <div className="min-h-0 flex-1 overflow-y-auto px-5 py-5">
            {showFallbackNotice && (
              <div className="mb-4 rounded-lg border border-warning/40 bg-warning/10 px-3 py-2 text-[12px] text-ink-300">
                {ui.fallbackNotice}
              </div>
            )}
